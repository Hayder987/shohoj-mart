      ...
      <nav className="max-w-[1300px] px-4 mx-auto">
        ...
        <div className="text-white flex justify-between items-center">
          ...
          <div className="relative">
            ...
            />
            <p className="absolute top-2 cursor-pointer text-2xl text-black right-3"><IoSearchOutline /></p>
          </div>
          {/* icon */}
          <div className="flex justify-between items-center gap-6">
            ...
            <button className="flex text-orange-300 flex-col cursor-pointer justify-center items-center">
              <span className="text-3xl "><FaRegHeart /></span>
            ...
            <button className="flex relative text-orange-300 flex-col cursor-pointer justify-center items-center">
              ...
              <span className="bg-blue-800 rounded-full text-xl text-white absolute -top-2 right-0">0</span>
            </button>
          </div>
        </div>
        {/* nav-2 */}
         ...
         <ul className="flex gap-8 items-center text-white">
          ...
          <div className="flex gap-6 cursor-pointer items-center">
            <div className="flex items-center gap-2 border-gray-100 border-r-2 px-5">
              <p className="text-blue-400 text-xl"><MdHelp /></p>
              <p className="text-gray-100">Help</p>
            </div>
            <div className="flex items-center gap-2">
            <p className="text-orange-300"><BsGift /></p>
